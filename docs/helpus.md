...
+ 如果发现了可能存在的Bug，你可以通知QQ群`858675200`的`管理员`。

+ 如果发现了熊孩子/外挂，请立刻通知QQ群`858675200`的`管理员`。

+ 如果发现玩家之间发生了很严重的争吵，也请立刻通知QQ群`858675200`的`管理员`。
...
你可以在QQ群 `858675200` 里上传你绘制的**物品.png**或者**模型.json**。
...
Java版Minecraft在插件开发方面有着独特的开放性。如果你对服务器插件开发感兴趣，掌握一定的开发技术，并且有意向为Morpheus提供有趣有用的扩展功能，那么欢迎你加入开发者的行列。插件可以使用[Java](https://www.liaoxuefeng.com/wiki/1252599548343744)或[Kotlin](https://www.kotlincn.net/docs/reference/basic-syntax.html)语言进行开发，你需要了解这些语言和主流的开发工具[IntelliJ IDEA](https://www.jetbrains.com/idea/)。如果需要了解插件开发，请移步[这里](https://plgdev.xuogroup.top/#/README)。
